          ...
          <div class="col-span-12 space-y-2.5">
            <div class="lg:mr-16">
              <p class="text-[#44566c] dark:text-color-910 leading-7">
                I'm Creative software Developer from Kampala, Uganda, working in
                web , mobile and desktop app development. I enjoy turning
      ...
      <div class="pb-12 px-2 sm:px-5 md:px-10 lg:px-14">
        ...
        <div class="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
          <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
            ...
            <div class="space-y-2">
              ...
              <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                Under web designing, i can develop dynamic and static websites.
              </p>
            </div>
          </div>
          ...
          <div class="about-box bg-[#fefaf0] dark:bg-transparent">
            ...
            />
            <div class="space-y-2">
              <h3 class="dark:text-white tekkxt-[22px] font-semibold">
                App Development
              </h3>
              <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                With mobile development i use flutter.
              </p>
            </div>
          </div>
          ...
          <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
            ...
            <div class="space-y-2">
              ...
              <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                With Ui/Ux i use figma design tool to come up with mockups.
              </p>
            </div>
          </div>
          ...
          <div class="about-box bg-[#fff0f8] dark:bg-transparent">
            ...
            <div class="space-y-2">
              ...
              <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">
                I can develop desktop applications.
              </p>
            </div>
          </div>
        </div>
